...
public final class DigestUtils {
     ...
     * @param digestSalt Byte Array with the digest salt being used
     * @return String with the message hashed with a certain algorithm
     */
    public static String hashify(String message,String algorithm,byte[] digestSalt){
        MessageDigest algorithmDigest=getMessageDigest(algorithm);
        String preHashedString=message+byteArrayAsString(digestSalt);
