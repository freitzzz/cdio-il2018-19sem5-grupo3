package cdiomyc.support.encryptions;
...
public final class OperatorsEncryption {
     ...
     * that the word could not be decrypted like the original word
     * @param word String with the word being encrypted
     * @param operator String with the encryption operator code being used
     * @param value Integer with the encryption value being used
     * @return String with the word encrypted with the Operators Encryption
     */
    public static String encrypt(String word,String operator,int value){
        operation=operatorCode(operator);
        randomValue=value;
        return encrypt(word);
    }
    ...
    /**
     * Returns the operator code by a string representation
     * @param operator String with the operator code as string
     * @return Integer with the operator value
     */
    private static int operatorCode(String operator){
        switch(operator.toUpperCase()){
            case "ADDITION":
                return ADDITION_ENCRYPTION_CODE;
            case "MULTIPLICATION":
                return MULTIPLICATION_ENCRYPTION_CODE;
            default:
                return BITWISE_ENCRYPTION_CODE;
        }
    }
}