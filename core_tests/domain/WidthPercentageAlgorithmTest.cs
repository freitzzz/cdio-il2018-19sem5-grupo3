...
namespace core_tests.domain {
    public class WidthPercentageAlgorithmTest {
        ...
        public void ensureApplyRestrictsSingleValueDimensions() {
            Console.WriteLine("ensureApplySucceeds");
            ...
            CustomizedProduct custom = new CustomizedProduct("#17", "Altair of the Hyperbolic Plane: Beltrami Pseudosphere", CustomizedMaterial.valueOf(Color.valueOf("Missing Link of the Annihilator: Absolute Zero", 100, 100, 100, 100), Finish.valueOf("der alte wurfelt nicht")), CustomizedDimensions.valueOf(100, 100, 100), product);
            WidthPercentageAlgorithm algorithm = new WidthPercentageAlgorithm();
            Input minInput = new Input("Minimum Percentage");
            minInput.value = "0.9";
            Input maxInput = new Input("Maximum Percentage");
        ...
        public void ensureApplyRemovesValuesFromDiscreteDimensions() {
            ...
            CustomizedProduct custom = new CustomizedProduct("#8", "Dual of Antinomy: Antinomic Dual", CustomizedMaterial.valueOf(Color.valueOf("Epigraph of the Closed Curve: Close Epigraph", 100, 100, 100, 100), Finish.valueOf("der alte wurfelt nicht")), CustomizedDimensions.valueOf(100, 100, 100), product);
            WidthPercentageAlgorithm algorithm = new WidthPercentageAlgorithm();
            Input minInput = new Input("Minimum Percentage");
            minInput.value = "0.9";
            Input maxInput = new Input("Maximum Percentage");
        ...
        public void ensureApplyCondensesDiscreteDimensions() {
            ...
            CustomizedProduct custom = new CustomizedProduct("#22", "Rinascimento of Projection: Project Amadeus", CustomizedMaterial.valueOf(Color.valueOf("Silver", 100, 100, 100, 100), Finish.valueOf("der alte wurfelt nicht")), CustomizedDimensions.valueOf(100, 100, 100), product);
            WidthPercentageAlgorithm algorithm = new WidthPercentageAlgorithm();
            Input minInput = new Input("Minimum Percentage");
            minInput.value = "0.9";
            Input maxInput = new Input("Maximum Percentage");
        ...
        public void ensureApplyRemovesDiscreteDimensions() {
            ...
            CustomizedProduct custom = new CustomizedProduct("#11", "Pandora of Forgotten Existence: Sealed Reliquary", CustomizedMaterial.valueOf(Color.valueOf("Durpa", 100, 100, 100, 100), Finish.valueOf("der alte wurfelt nicht")), CustomizedDimensions.valueOf(100, 100, 100), product);
            WidthPercentageAlgorithm algorithm = new WidthPercentageAlgorithm();
            Input minInput = new Input("Minimum Percentage");
            minInput.value = "0.9";
            Input maxInput = new Input("Maximum Percentage");
            ...
            algorithm.setInputValues(inputs);
            Product alteredProduct = algorithm.apply(custom, component);
            Assert.True(alteredProduct.widthValues.Count == 0);
        }
        /// <summary>
        ...
        public void ensureApplyChangesContinuousDimensionsLimits() {
            ...
            CustomizedProduct custom = new CustomizedProduct("#3", "Protocol of the Two-sided Gospel: X-Day Protocol", CustomizedMaterial.valueOf(Color.valueOf("Open the Missing Link", 100, 100, 100, 100), Finish.valueOf("der alte wurfelt nicht")), CustomizedDimensions.valueOf(100, 100, 100), product);
            WidthPercentageAlgorithm algorithm = new WidthPercentageAlgorithm();
            Input minInput = new Input("Minimum Percentage");
            minInput.value = "0.9";
            Input maxInput = new Input("Maximum Percentage");
        ...
        public void ensureApplyCondensesContinuousDimensions() {
            ...
            CustomizedProduct custom = new CustomizedProduct("#24", "Achievement Point", CustomizedMaterial.valueOf(Color.valueOf("Open the Steins Gate", 100, 100, 100, 100), Finish.valueOf("der alte wurfelt nicht")), CustomizedDimensions.valueOf(100, 100, 100), product);
            WidthPercentageAlgorithm algorithm = new WidthPercentageAlgorithm();
            Input minInput = new Input("Minimum Percentage");
            minInput.value = "0.9";
            Input maxInput = new Input("Maximum Percentage");
