...
namespace core.persistence
{
    /** 
    <summary>
        Interface that represents the repository functionalities for Material entities.
    </summary>
    ...
    <typeparam name = "string">Generic-Type of the repository persistence ID</typeparam>
        */
    public interface MaterialRepository : Repository<Material, string, string>, DataRepository<Material, string> {}
}