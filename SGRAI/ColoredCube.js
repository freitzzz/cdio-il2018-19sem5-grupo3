...
function main() {
  ...
  gl.clearColor(0.0, 0.0, 0.0, 1.0); //#00 00 00 BLACK
  //gl.clearColor(1.0, 1.0, 1.0, 1.0); //#FF FF FF WHITE
  ...
  mvpMatrix.setPerspective(30, 1, 1, 100); //perspective(FOVY,ASPECT,NEAR,FAR)
                                           //FOV ?
                                           //ASPECT ?
  ...
  // Draw the cube
  //gl.drawElements(gl.TRIANGLES, n, gl.UNSIGNED_BYTE, 0); //Desenha o cubo com cores 
  gl.drawElements(gl.LINE_STRIP, n, gl.UNSIGNED_BYTE, 0); //Desenha o cubo com linhas (wireframe) 
}
